function drawingLevel()
{
    ...
    {
        //belka 1
        createColisionAndDrawing(100, 200, 400, "#444444", 30, "Colision();", 0, 0);
        //belka 2
        createColisionAndDrawing(180, 500, 700, "#444444", 30, "Colision();", 0, 0);
        //belka 3
        createColisionAndDrawing(250, 800, 1000, "#444444", 30, "Colision();", 0, 0);
        //belka 4
        createColisionAndDrawing(325, 1100, 1200, "#444444", 30, "Colision();", 0, 0);
        //belka 5    
        createColisionAndDrawing(400, 1300, 1350, "#444444", 30, "Colision();", 0, 0);
        //belka 6    
        createColisionAndDrawing(450, 1450, 1620, "#444444", 30, "Colision();", 0, 0);
        //END
    ...
    {
        //belka 1
        createColisionAndDrawing(100, 250, 400, "#444444", 30, "Colision();", 0, 0);
        //belka 2
        createColisionAndDrawing(180, 50, 200, "#444444", 30, "Colision();", 0, 0);
        //belka 3
        createColisionAndDrawing(260, 250, 400, "#444444", 30, "Colision();", 0, 0);
        //belka 4
        createColisionAndDrawing(340, 50, 200, "#444444", 30, "Colision();", 0, 0);
        //belka 5
        createColisionAndDrawing(420, 250, 400, "#444444", 30, "Colision();", 0, 0);
        //belka 6
        createColisionAndDrawing(500, 50, 200, "#444444", 30, "Colision();", 0, 0);
        //belka 7
        createColisionAndDrawing(580, 250, 400, "#444444", 30, "Colision();", 0, 0);
        //lava 1
        createColisionAndDrawing(450, 520, 1380, "#a70000", 70, "Dead();", 20, 70);
        //belka 7
        createColisionAndDrawing(580, 600, 800, "#444444", 30, "Colision();", 0, 0);
        //belka 7
        createColisionAndDrawing(580, 1000, 1200, "#444444", 30, "Colision();", 0, 0);
        //belka 7
        createColisionAndDrawing(580, 1400, 1620, "#444444", 30, "Colision();", 0, 0);
        //END
