...
function createArrowButton(direction, x, y) {
    ...
    arrowIcon.addEventListener('contextmenu', (e) => e.preventDefault());
...
function createInteractButton(x, y) {
    ...
    interactionIcon.draggable = false;
    interactionIcon.addEventListener('contextmenu', (e) => e.preventDefault());
...
function renderItems(animatedItem = null) {
    ...
    items.forEach(item => {
        ...
        if (animatedItem && animatedItem.id === item.id) {
